...
export function EditAgentModal({
  ...
  const handleSubmit = async () => {
    ...
    // Note: tradingStrategyPrompt is auto-generated by backend and cannot be updated
        ...
        >
          ...
          <div className="px-6 py-4 space-y-6">
            ...
            <div>
              ...
              <textarea
                className="w-full px-4 py-3 bg-eva-darker border border-eva-border rounded-lg text-eva-text font-mono placeholder:text-eva-muted focus:outline-none focus:border-eva-primary transition-colors resize-none h-24"
            ...
            {/* Trading Strategy Prompt - Read Only */}
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-xs font-mono text-eva-text-dim uppercase tracking-widest">
              ...
              <textarea
                className="w-full px-4 py-3 bg-eva-darker/50 border border-eva-border/50 rounded-lg text-eva-text-dim font-mono resize-none h-24 cursor-not-allowed"
                disabled
